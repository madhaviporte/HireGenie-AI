      ...
      <div className="w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden">
        ...
        >
          ...
          <p className='text-gray-600 mb-10'>
            Practice real Interview scenarios powered by AI. Improve communication, technical skills, and confidence with instant feedback.
          </p>
        ...
        <motion.div
          ...
          <h2 className='text-3xl font-bold text-gray-800 mb-8'>Configure Your Interview</h2>

          <div className='space-y-6'>
            <div className='relative'>
              <FaUserTie className='absolute left-4 top-1/2 text-gray-400' />
            ...
            <div className='relative'>
              <FaBriefcase className='absolute left-4 top-1/2 text-gray-400' />
