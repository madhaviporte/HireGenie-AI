...
const Step2Interview = ({ interviewData, onFinish }) => {
  ...
  const [isAIPlaying, setIsPlaying] = useState(false)
  ...
  useEffect(() => {
    ...
    const runIntro = async () => {
      if (isIntroPhase) {
        ...
        await speackText(
          "I'll ask you a few questions. Just answer naturally, and take your time. let's begain."
        )
        ...
        if (currentIndex === questions.length - 1) {
          await speackText("Alright, this one might be a bit more challenging.")
        }
        await speackText(currentQuestion.question)
 ...
 const submitAnswer = async () => {
  ...
  try {
    ...
    await speackText(result.data.feedback)
  ...
  const handleNext = async () => {
    ...
    await speackText("Alright, let's move to the next question.")
