...
import confidencImg from '../assets/confi.png'
          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
            {
              [
                {
                  ...
                  desc: "AI adjust difficulty based on selected job roole."
                },
                {
                  icon: <BsMic size={24} />,
                  step: "STEP 2",
              ...
              `}>
                    ...
                    <div className='absolute -top-8 left-1/2 -translate-x-1/2 bg-white border-2 border-green-600 w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg'>
                      {item.icon}
                    </div>
            ...
            <div className='grid md:grid-cols-2 gap-10'>
              {
                [
                  ...
                  },
                  {
                    ...
                    desc: "Track pregress with performance graph and topic analysis"
                  }
                ].map((item, index) => {
                  return (
                    <motion.div key={index}
                      ...
                      className='bg-white border border-gray-200 rounded-3xl p-8 shadow-sm hover:shadow-xl tracking-all'>
            ...
            <div className='grid md:grid-cols-2 gap-10'>
              {
                [
                  ...
                  },
                  {
                   ...
                   desc: "Basis tone and voice analysis insights."
                  },
                  {
                   img:creditImg,
